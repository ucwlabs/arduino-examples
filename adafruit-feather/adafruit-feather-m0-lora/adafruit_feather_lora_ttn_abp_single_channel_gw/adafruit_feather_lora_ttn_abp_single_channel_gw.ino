 ...
 *
 *  This example is for a Single Channel LoRaWAN gateway
 * 
...
static const PROGMEM u1_t NWKSKEY[16] = { 0x41, 0x2B, 0x09, 0xF7, 0xA9, 0x34, 0x76, 0x1E, 0x55, 0x5E, 0xDB, 0x3A, 0x1E, 0xAC, 0x34, 0xDD };
...
static const u1_t PROGMEM APPSKEY[16] = { 0x5A, 0xDC, 0xFB, 0x84, 0x87, 0xFA, 0xD2, 0x3D, 0x07, 0x9F, 0x60, 0x52, 0xE1, 0x26, 0xE5, 0xF2 };

// LoRaWAN end-device address (DevAddr)
//static const u4_t DEVADDR = 0x26011885; // <-- Change this address for every node!
static const u4_t DEVADDR = 0x2601152A; // <-- Change this address for every node!
